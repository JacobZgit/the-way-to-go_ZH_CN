# 11.10 反射包
前排提醒，反射一般开发人员几乎用不到，写基础框架的话会用到，没基础可以先不学。(语法奇怪，强行记住即可，不必深究)

基础用法详情参考：https://haicoder.net/golang/golang-reflect.html

考虑一个很现实的问题。我们应该使用反射吗？我想引用 Rob Pike关于使用反射的格言，来回答这个问题。
